...
import com.ratemywork.repository.*;
...
public class DataInitializer implements CommandLineRunner {
    ...
    private void seedCategories() {
        ...
        for (String name : defaults) {
            if (!categoryRepository.existsByNameIgnoreCase(name)) {
                categoryRepository.save(new Category(name, com.ratemywork.service.CategoryService.slugify(name)));
            }
        }
    }
    ...
    private void seedDemoData() {
        ...
        User demoAuthor = userRepository.findByUsernameIgnoreCase("demo_reviewer").orElseGet(() -> {
            ...
            u.setEmail("demo.reviewer@ratemywork.local");
    ...
    private void seedFirstUpdate() {
        ...
        update.setTitle("Welcome to RateMyWork 🎉");
        update.setTag("launch");
        update.setBody("RateMyWork is live! Search workplaces, read verified employee feedback, and "
