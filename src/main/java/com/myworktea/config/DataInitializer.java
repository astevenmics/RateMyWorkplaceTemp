...
import com.myworktea.domain.Category;
import com.myworktea.domain.Role;
import com.myworktea.domain.User;
import com.myworktea.repository.CategoryRepository;
    ...
    private void seedCategories() {
        ...
        for (String name : defaults) {
            if (!categoryRepository.existsByNameIgnoreCase(name)) {
                categoryRepository.save(new Category(name, com.myworktea.service.CategoryService.slugify(name)));
            }
        }
    }
}