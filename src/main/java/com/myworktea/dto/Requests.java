...
public final class Requests {
    ...
    /** Casts/changes/retracts a vote on a rant. Voter identity is resolved server-side (see RantController). */
    public record VoteRequest(@NotBlank @Pattern(regexp = "UP|DOWN") String type) {
    }
