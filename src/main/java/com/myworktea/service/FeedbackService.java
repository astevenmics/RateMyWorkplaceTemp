...
public class FeedbackService {
    ...
    public Feedback moderate(Long id, boolean hide, String note) {
        ...
        auditService.record(com.myworktea.domain.AuditCategory.FEEDBACK,
                hide ? com.myworktea.domain.AuditAction.REJECTED : com.myworktea.domain.AuditAction.APPROVED,
