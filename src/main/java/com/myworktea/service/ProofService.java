...
import com.myworktea.repository.EmploymentProofRepository;
...
public class ProofService {
    ...
    public EmploymentProof review(Long id, boolean approve, String note, User reviewer) {
        ...
        String locationLabel = saved.getLocation() != null
                ? com.myworktea.dto.DtoMapper.locationLabel(saved.getLocation()) : null;
        ...
        auditService.record(com.myworktea.domain.AuditCategory.PROOF,
                approve ? com.myworktea.domain.AuditAction.APPROVED : com.myworktea.domain.AuditAction.REJECTED,
