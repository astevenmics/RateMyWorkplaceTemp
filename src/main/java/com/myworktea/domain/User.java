...
public class User {
    ...
    /**
     * Set when the user requests their own account deletion; null otherwise. The account is
     * disabled immediately, then permanently purged (feedback, proofs, etc. — but not workplaces
     * they submitted) once {@link #DELETION_GRACE_DAYS} have elapsed since this timestamp.
     */
